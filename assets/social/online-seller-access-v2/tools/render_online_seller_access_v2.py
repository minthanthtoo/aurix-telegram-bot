...
Outline VPN Key ကို AuriX Bot မှာ ဝယ်ယူနိုင်ပြီး VPN Quota လက်ကျန်ကို အချိန်မရွေး စစ်ဆေးနိုင်ပါတယ်။

AuriX က ထုတ်ပေးထားတဲ့ Key ဆိုရင် My VPN မှာ —
• သုံးပြီးသား Data ပမာဏ
• လက်ကျန် Data နဲ့ ရာခိုင်နှုန်း
• သက်တမ်းနဲ့ Key အခြေအနေ
တို့ကို ကိုယ်တိုင် အလွယ်တကူ စစ်ဆေးနိုင်ပါတယ်။
...
Connection speed နဲ့ latency က အသုံးပြုနေတဲ့ Network၊ ISP၊ တည်နေရာနဲ့ လက်ရှိ Server အခြေအနေပေါ် မူတည်နိုင်ပါတယ်။ AuriX ဟာ Outline Foundation နဲ့ ငွေလွှဲဝန်ဆောင်မှုပေးသူတွေရဲ့ တရားဝင်မိတ်ဖက် မဟုတ်ပါဘူး။
