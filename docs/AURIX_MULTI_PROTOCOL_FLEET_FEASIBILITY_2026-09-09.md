...
348 discovered tests after the reproducible Python environment installed OpenCV;
...
The complete local regression suite passes `348` tests. This does not change
