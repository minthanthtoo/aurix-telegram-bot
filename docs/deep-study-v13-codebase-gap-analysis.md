...
Current evidence is strong for code and controlled operations (407 tests,
...
- [`MVP_STATUS.md`](MVP_STATUS.md) and this document now report the verified
  407-test suite; update both whenever a release changes the test baseline.
...
2. Add CI using the declared Python version and run the full 407-test suite plus Ruff. **Done for the current release line.**
