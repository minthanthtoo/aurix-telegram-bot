...
Current evidence is strong for code and controlled operations (421 tests,
...
- [`MVP_STATUS.md`](MVP_STATUS.md) and this document now report the verified
  421-test suite; update both whenever a release changes the test baseline.
...
2. Add CI using the declared Python version and run the full 421-test suite plus Ruff. **Done for the current release line.**
