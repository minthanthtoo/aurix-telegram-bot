...
- Local test/evidence coverage: **100%** for the current fake-Outline, TLS,
  ...
  production-acceptance suite (476 tests passing at the latest verification).
