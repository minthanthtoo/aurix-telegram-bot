...
- Live deployment readiness: **staged, not 100%**. The deployed control plane
  is `913c2bd`, all required systemd services/timers are active, and the
  ...
  verification: 34.9 hours old). The overall result remains `warn` because the primary
