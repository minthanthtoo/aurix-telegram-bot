...
- Live deployment readiness: **staged, not 100%**. The deployed control plane
  is `7e27575`, all required systemd services/timers are active, and the
  ...
  verification: 35.1 hours old). The overall result remains `warn` because the primary
