...
- Local test/evidence coverage: **100%** for the current fake-Outline, TLS,
  ...
  production-acceptance suite (462 tests passing at the latest verification).
- Live deployment readiness: **staged, not 100%**. The deployed control plane
  is `4a236cf`, all required systemd services/timers are active, and the
