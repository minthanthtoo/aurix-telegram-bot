...
- Local test/evidence coverage: **100%** for the current fake-Outline, TLS,
  ...
  production-acceptance suite (458 tests passing at the latest verification).
- Live deployment readiness: **staged, not 100%**. The deployed control plane
  is `f801ddc`, all required systemd services/timers are active, and the
