        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(
                ...
                [
                    ...
                    ("commerce", 4, "generation_accounting_and_ambiguous_intents"),
                    ("commerce", 5, "durable_route_failover_decisions"),
                    ...
                    ("commerce", 11, "failover_safety_controls"),
                    ("commerce", 12, "versioned_failover_decisions"),
                    ...
                    ("commerce", 20, "dynamic_shadowsocks_profiles"),
                    ...
                    ("free_access", 10, "endpoint_usage_snapshot_status"),
                ],
            )
